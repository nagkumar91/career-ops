...
1. **Identify targets** via web_search:
...
4. **Generate message** using 3-sentence framework adapted to the contact type:
   ...
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement that demonstrates solving similar problems
